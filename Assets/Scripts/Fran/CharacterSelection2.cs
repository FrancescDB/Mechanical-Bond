...
public class CharacterSelection2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if (otherPlayer.GetComponent<CharacterSelection>().alreadySelected == false)
            {
            ...
            {
                if (otherPlayer.GetComponent<CharacterSelection>().selectionPosition == 1)
                {
                    selectionPosition = 2;
                }
                else
            ...
            if (selectionPosition == 1)
            {
                seleccionadorObj.transform.position = new Vector3(-5.81f, 15.1f, 2.74f);
            }
            else
            {
                seleccionadorObj.transform.position = new Vector3(2.64f, 15.1f, 2.74f);
            }
